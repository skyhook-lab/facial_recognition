...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/flutter_face_sdk/ios/Frameworks/fsdk.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_face_sdk/flutter_face_sdk.framework"
